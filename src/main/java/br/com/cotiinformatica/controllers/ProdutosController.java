...
//---------------------------------------------------------------------------------------------------------
	...
	@CrossOrigin("http://localhost:4200")  //quem tem a permissão de acesso
...
//------------------------------------------------------------------------------------------------------------
	...
	@ApiOperation("Serviço de atualização de produtos")
...
//-----------------------------------------------------------------------------------------------------------------
	...
	@ApiOperation("Serviço para deletar um produto")
	...
	public ResponseEntity<String> delete(@PathVariable("id") Integer id) {
		...
		try {
			...
			if(produto == null) {
				...
				//se encontrado, excluindo o produto
